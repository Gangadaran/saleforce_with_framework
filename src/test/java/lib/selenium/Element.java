 ...
 * @description This interface defines methods related to elements on a web page.
 * It provides a set of common operations that can be performed on web page elements, such as clicking, typing, selecting, and verifying.
 * To use this interface, implement its methods in a class that interacts with web page elements.
 * The methods can be used to perform operations on various types of elements, such as buttons, links, text fields, dropdowns, and checkboxes and many more.
 */
...
public interface Element {
	/**
	 * This method will click the element and take screenshot
	 * 
	 * @param - The element(button/link/element) to be clicked
	 * @see locateElement method in Browser interface
	 * @author Gangadaran - Aequalis
	 ...
	 * 
	 * @param ele  - The WebElement in which data to be entered
	 * @param data - The data to be sent to the WebElement
	 * @author Gangadaran - Aequalis
	 * @throws ElementNotInterableException,IllegalArgumentException(throws if
	 *                                                                      keysToSend
	 *                                                                      is null)
	 */
	 ...
	 * 
	 * @param ele - The WebElement(text field) in the value to be entered
	 * @see lacateElement method in Browser interface
	 * @author Gangadaran - Aequlis
	...
	/**
	 * This method will select the drop down using visible text
	 * 
	 ...
	 * 
	 * @param ele   - The webelement (dropdown) to be selected
	 * @param value - The value to be selected from dropdown
	 * @see locateElement method in Browser Class
	 * @author Gangadaran - Aequalis
	 */
